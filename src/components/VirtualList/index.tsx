...
export default class VirtualList extends Vue {
  ...
  @Prop({ type: Function || Boolean, default: false }) variable: Function | boolean;
  @Prop({ type: Number, default: 0 }) bench: number;
  @Prop({ type: Number, default: 0 }) debounce: number;
  @Prop({ type: Function || Boolean, default: false }) toTop: Function | boolean;
  @Prop({ type: Function || Boolean, default: false }) tobottom: Function | boolean;
  @Prop({ type: Function || Boolean, default: false }) onscroll: Function | boolean;
